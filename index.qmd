...
```{r dsl, echo=FALSE, fig.cap="The Data Science Lifecycle", out.width = '80%', fig.align='center'}
knitr::include_graphics("figures/aq-data-science-lifecycle.png")
```
...
MTH-391, 3 credits, one-time course offering for Spring 2025
...
[Alex John Quijano](https://www.alexjohnquijano.com){target="_blank"} -- [quijano@up.edu](quijano@up.edu){target="_blank"}
...
1. "Data science is the same as machine learning."
...
2. "Data science is all about coding."
...
3. "Advanced mathematics are needed to be a 'good' data scientist."

    Mathematics are useful but not a strict requirement for success as a data scientist. A balance of technical, analytical, and domain knowledge is more critical with a basic understanding of statistics, calculus, and linear algebra.

4. "Data science is the solution to all problems."
...
5. "Talking about your data analysis results is not important."
...
7. "You can finish a well-written data science project alone."
    
    A well-written data science project incorporates multiple perspectives and areas of expertise. As the saying goes, 'the real lesson you learn in your educational journey is the friendships you make along the way.'
