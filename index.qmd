...
**Name:** Dr. [Alex John Quijano](https://www.alexjohnquijano.com){target="_blank"} 

**Email:** [quijano@up.edu](quijano@up.edu){target="_blank"}
...
2. "Data science is all about coding."
    ...
    While using R or Python as programming tools for data analysis, hardcore coding is not the primary goal of data science. Instead, think of R and Python as advanced calculators (like the TI-89 or Excel) that can handle large and complex data sets.

3. "Advanced mathematics are needed to be a data scientist."
